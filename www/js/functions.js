    ...
    switch ($.mobile.activePage.attr('id')) {
        case 'level_page':
            ...
            if ($php_data['loudness_track']==true) {			
                $("#level_display22").text("Loud ON");
            }
            else  {
                $("#level_display22").text("Loud OFF");
            }
        ...
        case 'drc_page':
            ...
            if ($php_data['system_eq'] == true) {
                $("#drc_display").append("<br/>System EQ ON");
                $("#syseq_switch").attr("value","on").slider("refresh");
            }
            else {
                $("#drc_display").append("<br/>System EQ OFF");
                $("#syseq_switch").attr("value","off").slider("refresh");
            }
            $("#drc_display").append(" --- DRC: " + $php_data["drc_eq"] + "/" + ($php_data["drc_index"]-1).toString());
...
// Esto está fusilado de arriba #inputs_page
