        ...
        <div data-role="content">
            ...
            <div class="content-primary">
                <div data-role="content" id="level_display" class="display display2 ui-corner-all">
                    ...
                    <div class="ui-grid-a">
                        <div class="ui-block-a" id="level_display21" style="max-width:160px; min-width:130px"></div>
                        <div class="ui-block-b" id="level_display22"></div>
                        <div class="ui-block-a" id="level_display31" style="max-width:160px; min-width:130px"></div>
                        <div class="ui-block-b" id="level_display32"></div>
                        <div class="ui-block-a" id="level_display41" style="max-width:160px; min-width:130px"></div>
                        <div class="ui-block-b" id="level_display42"></div>
                        <div class="ui-block-a" id="level_display51" style="max-width:160px; min-width:130px"></div>
                        <div class="ui-block-b" id="level_display52"></div>
                        <!-- MONO -->
                        <div class="ui-block-a" id="level_display53" style="max-width:160px; min-width:130px"></div>
                        <!-- PEQ -->
                        <div class="ui-block-b" id="level_display55" style="max-width:160px; min-width:130px"></div>
                    </div><!-- /grid-a -->

                  <!-- PRESETS -->
                  <div class="ui-grid-solo" id="level_display54" style="max-width:6400px; min-width:320px"></div>
                  
                  <div class="ui-grid-solo" id="level_display6"></div>
                </div>
                <p></p>
